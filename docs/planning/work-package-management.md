...
| WP18 — Tenant kimliği ve data isolation      | Uygulandı / kabul bekliyor | OIDC, deny-by-default authorization, RLS/object/cache tenant sınırı bağımsız kabul bekliyor                 |
